...
local function CDs ()
  ...
  if S.BladeFlurry:IsReady() and S.UnderhandedUpperhand:IsAvailable() and not Player:StealthUp(true, false) and
    Player:BuffRemains(S.BladeFlurry) < Player:GCDRemains() and not Finish_Condition() then
