...
local function Finish_Condition ()
  ...
  return EffectiveComboPoints >= Rogue.CPMaxSpend() - 1 - (Player:StealthUp(true, true) and S.Crackshot:IsAvailable() and 1 or 0)
end
...
local function Ambush_Condition ()
  ...
  return Energy >= 50 and (S.HiddenOpportunity:IsAvailable() or
...
local function Blade_Flurry_Sync ()
  return not AoEON() or EnemiesBFCount < 2 or Player:BuffRemains(S.BladeFlurry) > Player:GCD()
end
